...
export const POSTS_PATH = join(process.cwd(), 'apps/pellegrims-dev/_blog');

export const facebookSvgIcon =
  'M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z';
export const facebookUrl = 'https://www.facebook.com/robin.pellegrims';
...
export const name = 'Robin Pellegrims';
